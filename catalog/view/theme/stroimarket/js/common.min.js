    ...
    'add': function(product_id) {
        $.ajax({
            ...
            success: function(json) {
                ...
                if (json['success']) {
                    $("body").append('<div class="alert-wish toast align-items-center" role="alert" aria-live="assertive" aria-atomic="true"><div class="d-flex"><div class="toast-body">Hello, world! This is a toast message.</div><button type="button" class="btn-close me-2 m-auto" data-bs-dismiss="toast" aria-label="Close"></button></div></div>');
                    if (window.innerWidth >= 992) {
                        $(".alert-wish").animate({
                            top: 44
                        }, 100)
