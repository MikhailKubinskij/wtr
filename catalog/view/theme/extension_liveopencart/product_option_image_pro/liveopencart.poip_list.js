...
var poip_list = (function($){
	let poip_list = {
		...
		wrapThumbsHtml : function(html) {
			...
			return '<div data-poip_id="poip_img" class="poip_img" style="  text-align: center; margin-top: 3px;"><div class="poip-shw">'+html+'</div></div>';
		},
		
		displayThumbs : function($product_anchor, html) {
			$product_anchor.closest('.product-item__image').after(html);
		},
